        ...
        <div className="container">
          <div className="infos">
            ...
            <div className="buttons pt-3">
              ...
              <a href="public\assets\resume\Marco_Resume.pdf" download><button className="btn btn-dark rounded" href="public\assets\resume\Marco_Resume.pdf" download>DOWNLOAD RESUME</button></a>
            </div>
        ...
        <div className="container mt-5">
          <div className="row text-center text-md-left">
            ...
            <div className="pl-md-4 col-md-9">
              ...
              <a href="public\assets\resume\Marco_Resume.pdf" download><button className="btn btn-primary rounded mt-3">DOWNLOAD RESUME</button></a>
            </div>
          </div>
        </div>
      </section>
