              ...
              <div className="row text-left">
                  <div className="col-md-4">
                      <div className="card border mb-4">
                          ...
                          <div className="card-body">
                              <h5 className="card-title">Designe htmlfor Everyone</h5>
                  ...
                  <div className="card-body text-light">
                      <div className="row align-items-center">
                          <div className="col-sm-9 text-center text-sm-left">
                              <h5 className="mt-3">Hire Me htmlfor Your Project</h5>
                  ...
                  <div className="htmlform">
                      ...
                      <htmlform>
                          <div className="htmlform-group">
                              <input type="email" className="htmlform-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email" required/>
                          </div>
                          <div className="htmlform-group">
                              <input type="password" className="htmlform-control" id="exampleInputPassword1" placeholder="Password" required/>
                          </div>
                          <div className="htmlform-group">
                              <textarea name="contact-message" id="" cols="30" rows="5" className="htmlform-control" placeholder="Message"></textarea>
                          </div>
